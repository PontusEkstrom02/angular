...
import { DescriptionItem, Task } from '../task.model';

@Component({
  selector: 'app-todo-list-site',
  templateUrl: './todo-list-site.component.html',
  styleUrls: ['./todo-list-site.component.sass']
})
export class TodoListSiteComponent {
  tasks: Task[] = [
    {
      id: 1,
